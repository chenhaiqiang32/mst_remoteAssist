export default {
  ...
  'settings.application': 'Quick access',
  ...
  'notification.title': 'Remote assistance notification',
  'notification.assist.title': 'You have a call request',
  'notification.message.title': 'You have a session message',
};
